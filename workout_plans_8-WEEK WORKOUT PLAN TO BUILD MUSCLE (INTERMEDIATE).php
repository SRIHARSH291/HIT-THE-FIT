...
<br><br><br><br><br>
<div class="HEADINGS">
    <h1>8-WEEK WORKOUT PLAN TO BUILD MUSCLE (INTERMEDIATE)</h1>
    <h6>WORKOUT-PLANS</h6>
</div>
...
<div class="week">
    <div class="week_title">Week-1</div>
        ...
        <div class="entry">
            <a href="workout_plans_8-WEEK WORKOUT PLAN TO BUILD MUSCLE (INTERMEDIATE)_day-1,8,15,22,29,36,43,50.php">
            <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_6-WEEK-ADVANCED-WORKOUT-PLAN-TO-BUILD-MUSCLE/bench-1-icon.png">
            <div class="day">Day 1</div>
            </a>
            <div class="title">Chest + TRICEPS</div>
        </div>
        <div class="entry">
            <a href="workout_plans_8-WEEK WORKOUT PLAN TO BUILD MUSCLE (INTERMEDIATE)_day-2,9,16,23,30,37,44,51.php">
            <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_6-WEEK-ADVANCED-WORKOUT-PLAN-TO-BUILD-MUSCLE/workout-1-icon.png">
            <div class="day">Day 2</div>
            </a>
            <div class="title">back + biceps</div>
        </div>
        <div class="entry">
            <a href="workout_plans_8-WEEK WORKOUT PLAN TO BUILD MUSCLE (INTERMEDIATE)_day-3,7,10,17,24,31,38,7,14,21,28,35,42,45,49,52,56.php">
            <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_6-WEEK-ADVANCED-WORKOUT-PLAN-TO-BUILD-MUSCLE/rest-1-icon.png">
            <div class="day">Day 3</div>
            </a>
            <div class="title">rest</div>
        </div>
        <div class="entry">
            <a href="workout_plans_8-WEEK WORKOUT PLAN TO BUILD MUSCLE (INTERMEDIATE)_day-4,11,18,25,32,39,46,53.php">
            <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_6-WEEK-ADVANCED-WORKOUT-PLAN-TO-BUILD-MUSCLE/workou-2-icon.png">
            <div class="day">Day 4</div>
            </a>
            <div class="title">shoulders</div>
        </div>
        <div class="entry">
            <a href="workout_plans_8-WEEK WORKOUT PLAN TO BUILD MUSCLE (INTERMEDIATE)_day-5,12,19,26,33,40,47,54.php">
            <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_6-WEEK-ADVANCED-WORKOUT-PLAN-TO-BUILD-MUSCLE/power-muscle-1-icon.png">
            <div class="day">Day 5</div>
            </a>
            <div class="title">abs + forearms</div>
        </div>
        <div class="entry">
            <a href="workout_plans_8-WEEK WORKOUT PLAN TO BUILD MUSCLE (INTERMEDIATE)_day-6,13,20,27,34,41,48,55.php">
            <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_6-WEEK-ADVANCED-WORKOUT-PLAN-TO-BUILD-MUSCLE/dumbbell-1-icon.png">
...
<div class="week">
    <div class="week_title">Week-5</div>
...
<div class="week">
    <div class="week_title">Week-6</div>
        
        <div class="entry">
            <a href="workout_plans_8-WEEK WORKOUT PLAN TO BUILD MUSCLE (INTERMEDIATE)_day-1,8,15,22,29,36,43,50.php">
            <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_6-WEEK-ADVANCED-WORKOUT-PLAN-TO-BUILD-MUSCLE/bench-1-icon.png">
            <div class="day">Day 36</div>
            </a>
            <div class="title">Chest + TRICEPS</div>
        </div>
        <div class="entry">
...
<div class="week">
    <div class="week_title">Week-7</div>
        
        <div class="entry">
            <a href="workout_plans_8-WEEK WORKOUT PLAN TO BUILD MUSCLE (INTERMEDIATE)_day-1,8,15,22,29,36,43,50.php">
            <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_6-WEEK-ADVANCED-WORKOUT-PLAN-TO-BUILD-MUSCLE/bench-1-icon.png">
            <div class="day">Day 43</div>
            </a>
            <div class="title">Chest + TRICEPS</div>
        </div>
        <div class="entry">
...
<div class="week">
    <div class="week_title">Week-8</div>
        
        <div class="entry">
            <a href="workout_plans_8-WEEK WORKOUT PLAN TO BUILD MUSCLE (INTERMEDIATE)_day-1,8,15,22,29,36,43,50.php">
            <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_6-WEEK-ADVANCED-WORKOUT-PLAN-TO-BUILD-MUSCLE/bench-1-icon.png">
            <div class="day">Day 50</div>
            </a>
            <div class="title">Chest + TRICEPS</div>
        </div>
        <div class="entry">
