...
<br><br><br><br><br>
<div class="HEADINGS">
    <h1>4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)</h1>
    <h6>WORKOUT-PLANS</h6>
</div>
...
<div class="week">
    <div class="week_title">Week-1</div>
        ...
        <div class="entry">
            <a href="workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)-1,5,8,12,15,19,22,26.php">
            <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/bench-1-icon.png">
            <div class="day">Day 1</div>
            </a>
            <div class="title">push</div>
        </div>
        <div class="entry">
            <a href="workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)-2,6,9,13,16,20,23,27.php">
            <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/workout-1-icon.png">
            <div class="day">Day 2</div>
            </a>
            <div class="title">pull</div>
        </div>
        <div class="entry">
            <a href="workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)-3,7,10,14,17,21,24,28.php">
            <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/workou-2-icon.png">
            <div class="day">Day 3</div>
            </a>
            <div class="title">legs</div>
        </div>
        <div class="entry">
            <a href="workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)-4,11,18,25.php">
            <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/rest-1-icon.png">
