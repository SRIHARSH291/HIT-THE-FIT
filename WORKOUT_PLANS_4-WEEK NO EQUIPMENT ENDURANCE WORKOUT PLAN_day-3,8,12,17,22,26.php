...
<div class="card" style="width: 18rem; ">
  <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/speed & agility/Decline-Push-Up.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">DECLINE-PUSH-UPS</h5>
    <p class="card-text">Equipment: NO EQUIPMENT<br>
Primary Muscles: SPEED & AGILITY</p>
  </div>
</div>
</div>
<div class="col-12">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/speed & agility/Jump-Squat.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">JUMP-SQUAT</h5>
    <p class="card-text">Equipment:  NO EQUIPMENT<br>
Primary Muscles: SPEED & AGILITY</p>
  </div>
  </div>
...
<div class="row">
    <div class="col-11">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/speed & agility/Run.gif" class="card-img-top">
  <div class="card-body">
...
<div class="col-12">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/speed & agility/Skater.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">SKATER</h5>
    <p class="card-text">Equipment: NO EQUIPMENT<br>
Primary Muscles: SPEED & AGILITY</p>
</div>
</div>
...
<div class="row">
    <div class="col-11">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/speed & agility/T-Cross-Sit-up.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">T-CROSS-SIT</h5>
    <p class="card-text">Equipment: NO EQUIPMENT<br>
Primary Muscles: SPEED & AGILITY</p>
  </div>
</div>
...
<div class="col-12">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/speed & agility/Toe-Reaches.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">TOE-REACHES</h5>
    <p class="card-text">Equipment: NO EQUIPMENT<br>
Primary Muscles: SPEED & AGILITY</p>
  </div>
</div>
