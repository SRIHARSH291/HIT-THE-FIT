...
<div class="HEADINGS">
    <h1>LEGS WORKOUT</h1>
    <h6>WORKOUT-PLANS</h6>
    <H3>4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)</H3>
</div>
<br><br><br>
...
<div class="card" style="width: 18rem; ">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/leg/Barbell-Hip-Thrust.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">Barbell-Hip-Thrust</h5>
    <p class="card-text">Equipment: Barbell, Bench<br>
Primary Muscles: leg-Workouts</p>
  </div>
</div>
</div>
...
<div class="col-12">
<div class="card"  style="width: 18rem; ">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/leg/Barbell-Romanian-Deadlift.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">Barbell-Romanian-Deadlift</h5>
...
<div class="row">
    <div class="col-11">
<div class="card" style="width: 18rem; ">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/leg/BARBELL-SQUAT.gif" class="card-img-top">
  <div class="card-body">
...
<div class="col-12">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/leg/Decline-Sit-up.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">Decline-Sit-ups</h5>
    <p class="card-text">Equipment: Decline-Bench<br>
Primary Muscles: leg-Workouts</p>
  </div>
  </div>
  </div>
...
<div class="row">
    <div class="col-11">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/leg/Dumbbell-Bulgarian-Split-Squat.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">Bulgarian-Split-Squat</h5>
    <p class="card-text">Equipment: Dumbell, Bench<br>
Primary Muscles: leg-Workouts</p>
  </div>
</div>
</div>
<div class="col-12">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/leg/Dumbbell-Calf-Raise.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">Dumbbell-Calf-Raise</h5>
    <p class="card-text">Equipment: Dumbells<br>
Primary Muscles: leg-Workouts</p>
</div>
</div>
  </div>
...
<div class="row">
    <div class="col-11">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/leg/Leg-Curl.gif" class="card-img-top">
  <div class="card-body">
...
<div class="col-12">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/leg/Lying-Leg-Raise.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">Lying-Leg-Raise</h5>
