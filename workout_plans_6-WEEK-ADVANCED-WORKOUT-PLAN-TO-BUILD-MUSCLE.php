...
<br><br><br><br><br>
<div class="HEADINGS">
    <h1>6-WEEK ADVANCED WORKOUT PLAN TO BUILD MUSCLE</h1>
    <h6>WORKOUT-PLANS</h6>
</div>
...
<div class="week">
    <div class="week_title">Week-1</div>
        ...
        <div class="entry">
            <a href="workout_plans_6-week-advanced-workout-plan-to-build-muscle_day-1,8,15,22,29,36.php">
        ...
        <div class="entry">
            <a href="workout_plans_6-week-advanced-workout-plan-to-build-muscle_day-2,9,16,23,30,37.php">
            <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_6-WEEK-ADVANCED-WORKOUT-PLAN-TO-BUILD-MUSCLE/workout-1-icon.png">
            <div class="day">Day 2</div>
            </a>
            <div class="title">back + forearms</div>
        </div>
        <div class="entry">
            <a href="workout_plans_6-week-advanced-workout-plan-to-build-muscle_day-3,10,17,24,31,38,7,14,21,28,35,42.php">
        ...
        <div class="entry">
            <a href="workout_plans_6-week-advanced-workout-plan-to-build-muscle_day-4,11,18,25,32,39.php">
        ...
        <div class="entry">
            <a href="workout_plans_6-week-advanced-workout-plan-to-build-muscle_day-5,12,19,26,33,40.php">
            <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_6-WEEK-ADVANCED-WORKOUT-PLAN-TO-BUILD-MUSCLE/power-muscle-1-icon.png">
            <div class="day">Day 5</div>
            </a>
            <div class="title">arms + forearms</div>
        </div>
        <div class="entry">
            <a href="workout_plans_6-week-advanced-workout-plan-to-build-muscle_day-6,13,20,27,34,41.php">
            <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_6-WEEK-ADVANCED-WORKOUT-PLAN-TO-BUILD-MUSCLE/dumbbell-1-icon.png">
            <div class="day">Day 6</div>
            </a>
            <div class="title">legs + Abs</div>
        </div>
        <div class="entry">
            <a href="workout_plans_6-week-advanced-workout-plan-to-build-muscle_day-3,10,17,24,31,38,7,14,21,28,35,42.php">
            <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_6-WEEK-ADVANCED-WORKOUT-PLAN-TO-BUILD-MUSCLE/rest-1-icon.png">
