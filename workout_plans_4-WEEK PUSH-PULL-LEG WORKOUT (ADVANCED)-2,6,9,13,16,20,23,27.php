...
<div class="card" style="width: 18rem; ">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/pull/Barbell-Bent-Over-Row.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">Barbell-Bent-Over-Row</h5>
    <p class="card-text">Equipment: Barbell<br>
Primary Muscles: Pull-Workouts</p>
  </div>
</div>
</div>
...
<div class="col-12">
<div class="card"  style="width: 18rem; ">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/pull/Barbell-Curl.gif" class="card-img-top">
  <div class="card-body">
...
<div class="row">
    <div class="col-11">
<div class="card" style="width: 18rem; ">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/pull/barbell-uprightrow.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">barbell-uprightrow</h5>
    <p class="card-text">Equipment: Barbell<br>
Primary Muscles: Pull-Workouts</p>
  </div>
</div>
...
<div class="col-12">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/pull/barbell-Wrist-Curl.gif" class="card-img-top">
  <div class="card-body">
...
<div class="row">
    <div class="col-11">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/pull/close-grip-cable-row.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">close-grip-cable-row</h5>
...
<div class="col-12">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/pull/Concentration-Curl.gif" class="card-img-top">
  <div class="card-body">
...
<div class="row">
    <div class="col-11">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/pull/Pull-up.gif" class="card-img-top">
  <div class="card-body">
...
<div class="col-12">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/pull/Seated-Incline-Dumbbell-Curl.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">Incline-Dumbbell-Curl</h5>
    <p class="card-text">Equipment: Bench, Dumbell<br>
Primary Muscles: Pull-Workouts</p>
  </div>
</div>
</div>
