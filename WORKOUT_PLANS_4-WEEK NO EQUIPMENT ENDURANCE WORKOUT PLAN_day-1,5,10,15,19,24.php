...
<br><br><br><br><br>
<div class="HEADINGS">
    <h1>FULL BODY ENDURANCE</h1>
    <h6>WORKOUT-PLANS</h6>
    <H3>4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN</H3>
</div>
<br><br><br>
...
<div class="card" style="width: 18rem; ">
  <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/full body endurance/Bicycle-Crunch.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">BICYCLE-CRUNCH</h5>
    <p class="card-text">Equipment: NO EQUIPMENT<br>
Primary Muscles: FULL BODY ENDURANCE</p>
  </div>
</div>
</div>
...
<div class="col-12">
<div class="card"  style="width: 18rem; ">
  <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/full body endurance/Bodyweight-Squat.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">BODYWEIGT-SQUAT</h5>
    <p class="card-text">Equipment: NO EQUIPMENT<br>
Primary Muscles: FULL BODY ENDURANCE</p>
  </div>
</div>
...
<div class="row">
    <div class="col-11">
<div class="card" style="width: 18rem; ">
  <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/full body endurance/Jump-Rope.gif" class="card-img-top">
  <div class="card-body">
...
<div class="col-12">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/full body endurance/plank.gif" class="card-img-top">
  <div class="card-body">
...
<div class="row">
    <div class="col-11">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/full body endurance/Push-Up.gif" class="card-img-top">
  <div class="card-body">
...
<div class="col-12">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/full body endurance/Superman-exercise.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">SUPERMAN-EXERCISE</h5>
    <p class="card-text">Equipment: NO EQUIPMENT<br>
Primary Muscles: FULL BODY ENDURANCE</p>
</div>
</div>
...
<div class="row">
    <div class="col-11">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/full body endurance/Triceps-dips-on-floors.gif" class="card-img-top">
  <div class="card-body">
...
<div class="col-12">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/full body endurance/wall-slide.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">WALL-SLIDE</h5>
    <p class="card-text">Equipment: NO EQUIPMENT<br>
Primary Muscles: FULL BODY ENDURANCE</p>
  </div>
</div>
