...
<div class="week">
    <div class="week_title">Week-1</div>
        ...
        <div class="entry">
            <a href="WORKOUT_PLANS_4-WEEK 5×5 WORKOUT PLAN_day-1,5,10,15,19,24.php">
            <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/bodybuilding-1-icon.png">
            <div class="day">Day 1</div>
            </a>
            <div class="title">5x5 WORKOUT A</div>
        </div>
        <div class="entry">
            <a href="WORKOUT_PLANS_4-WEEK 5×5 WORKOUT PLAN_day-2,4,6,7,9,11,13,14,16,18,20,21,23,25,27,28.php">
