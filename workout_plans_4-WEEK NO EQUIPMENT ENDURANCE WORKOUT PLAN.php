...
<br><br><br><br><br>
<div class="HEADINGS">
    <h1>4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN</h1>
    <h6>WORKOUT-PLANS</h6>
</div>
...
<div class="week">
    <div class="week_title">Week-1</div>
        ...
        <div class="entry">
            <a href="WORKOUT_PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN_day-1,5,10,15,19,24.php">
            <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/bodybuilding-1-icon.png">
            <div class="day">Day 1</div>
            </a>
            <div class="title">full body endurance</div>
        </div>
        <div class="entry">
            <a href="WORKOUT_PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN_day-2,4,6,7,9,11,13,14,16,18,20,21,23,25,27,28.php">
            <img src="IMAGES/WORKOUT-PLANS/rest-1-icon.png">
            <div class="day">Day 2</div>
            </a>
            <div class="title">rest</div>
        </div>
        <div class="entry">
            <a href="WORKOUT_PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN_day-3,8,12,17,22,26.php">
            <img src="IMAGES/WORKOUT-PLANS/WORKOUT-PLANS_4-WEEK NO EQUIPMENT ENDURANCE WORKOUT PLAN/cardio-1-icon.png">
