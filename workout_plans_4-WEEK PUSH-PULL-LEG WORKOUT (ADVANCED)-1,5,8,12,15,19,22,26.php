...
<div class="card" style="width: 18rem; ">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/push/Barbell-Bench-Press.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">Barbell-Bench-Press</h5>
    <p class="card-text">Equipment: Barbell, Bench<br>
Primary Muscles: Push-Workouts</p>
  </div>
</div>
</div>
...
<div class="col-12">
<div class="card"  style="width: 18rem; ">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/push/Barbell-Standing-Military-Press.gif" class="card-img-top">
  <div class="card-body">
...
<div class="row">
    <div class="col-11">
<div class="card" style="width: 18rem; ">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/push/Cable-Tricep-Kickback.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">Cable-Tricep-Kickback</h5>
    <p class="card-text">Equipment: Cable<br>
Primary Muscles: Push-Workouts</p>
  </div>
</div>
...
<div class="col-12">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/push/Dumbbell-Bent-Arm-Laterl-Raise.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">Bent-Arm-Laterl-Raise</h5>
...
<div class="row">
    <div class="col-11">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/push/Dumbbell-Front-Raise.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">Dumbbell-Front-Raise</h5>
    <p class="card-text">Equipment: Dumbbells<br>
Primary Muscles: Push-Workouts</p>
  </div>
</div>
...
<div class="col-12">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/push/Incline-Barbell-Bench-Press.gif" class="card-img-top">
  <div class="card-body">
...
<div class="row">
    <div class="col-11">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/push/Pec-Deck-Fly.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">Pec-Deck-Fly</h5>
    <p class="card-text">Equipment: Butterfly Machine<br>
Primary Muscles: Push-Workouts</p>
  </div>
</div>
</div>
<div class="col-12">
<div class="card" style="width: 18rem;">
  <img src="IMAGES/WORKOUT-PLANS/workout_plans_4-WEEK PUSH-PULL-LEG WORKOUT (ADVANCED)/push/Pushdown.gif" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">Pushdown</h5>
    <p class="card-text">Equipment: Cable<br>
Primary Muscles: Push-Workouts</p>
  </div>
</div>
