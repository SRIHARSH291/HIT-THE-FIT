...
<!--ALL WORKOUT GIFS of GYM WORKOUT EXERCIES-->
...
<button><a href="fullbody_backward-medicine-ball-throw.php"> VIEW DETAILS </a></button>
</div>
...
<div class="card" style="width: 18rem; ">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Equipment: Tire<br>
      Primary Muscles: Full Body</p>
  </div>
</div>
</div>
...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Equipment: Hammer, Tire<br>
Primary Muscles: Full Body</p>
  </div>
  </div>
  </div>
